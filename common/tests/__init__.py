...
from plugins.module_utils import metal


here = os.path.dirname(os.path.abspath(os.path.dirname(__file__)))
MODULES_PATH = os.path.join(here, 'plugins/modules')
MODULE_UTILS_PATH = os.path.join(here, 'plugins/module_utils')
INVENTORY_PATH = os.path.join(here, 'plugins/inventory')
FILTER_PLUGINS_PATH = os.path.join(here, 'plugins/filter_plugins')
ACTION_PLUGINS_PATH = os.path.join(here, 'plugins/action_plugins')
